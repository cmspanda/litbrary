...
class SimpleGreeting extends s {
  static properties = {
    name: {},
    color: {},
  };
  ...
  render() {
    return x`<p style="--text-color:${this.color}">Hello, ${this.name}!</p>`;
  }
}
...
class Teaser extends s {
    ...
    createHeaderLevel (level, title) {
        ...
        switch(level) {
            case 1:  
                headerHtml = x`<h1 class="teaser-header">${title}</h1>`;
                break;
            case 2:  
                headerHtml = x`<h2 class="teaser-header">${title}</h2>`;
                break;
            case 3:  
                headerHtml = x`<h3 class="teaser-header">${title}</h3>`;
                break;
            case 4:  
                headerHtml = x`<h4 class="teaser-header">${title}</h4>`;
                break;
            case 5:  
                headerHtml = x`<h5 class="teaser-header">${title}</h5>`;
                break;
            default:
                headerHtml = x`<h class="teaser-header"2>${title}</h2>`;
        }
